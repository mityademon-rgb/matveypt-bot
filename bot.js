...
Я Матвей — ваш продюсер на Первом туристическом. Помогу разобраться, какие форматы подойдут под вашу задачу, как лучше запустить рекламу и во сколько она реально обойдётся.

Внизу есть быстрые кнопки: можно посмотреть информацию о канале, о наших рекламных возможностях или сразу запустить расчёт бюджета.

Расскажите пару слов о себе — как вас зовут и что вы делаете? 🚀`;
